                                                    ...
                                                    <div class="tab-content">
                                                        <div class="card">
                                                            <div class="card-block box-list p-l-40">
                                                                <h4 class="sub-title ">#period 1</h4>
                                                                <div class="form-group row">
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="p-20 z-depth-bottom-0 waves-effect" data-toggle="tooltip" data-placement="top" title="period">
                                                                            <a href="event_period_detail_ticket.php?id=<?php echo $event['event_id']; ?>"><span class="text-sm-left"><b>VIP</b></span><br></a>
                                                                            <span class="text-sm-left">Jumlah : </span><br>
                                                                            <span class="text-sm-left">Harga: </span><br>

                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="p-20 z-depth-bottom-0 waves-effect" data-toggle="tooltip" data-placement="top" title="period">
                                                                            <a href="event_detail_period.php"><span class="text-sm-left"><b>Platinum</b></span><br></a>
                                                                            <span class="text-sm-left">Jumlah : </span><br>
                                                                            <span class="text-sm-left">Harga: </span><br>
                                                                        </div>
                                                                    </div>
