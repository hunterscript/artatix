                            ...
                            <div class="main-body">
                                ...
                                <?php
                                    if (isset($_GET['pesan'])) {
                                        ...
                                        }elseif ($_GET['pesan'] = "success_edit_event") {
                                            echo "<div class='alert alert-success' role='alert'>Event berhasil diedit</div>";
                                        }
                                    }
                                ?>
                                                                                                ...
                                                                                                <div class="modal-content">
                                                                                                    ...
                                                                                                    <div class="modal-body">
                                                                                                        ...
                                                                                                        <div class="form-group row">
                                                                                                            ...
                                                                                                            <div class="col-sm-8">
                                                                                                                <input type="text" name="tkt_fee" class="form-control" placeholder="RP 100.000">
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="form-group row">
