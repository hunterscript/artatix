...
<body>
	...
	<section class="home-banner-area relative" id="home">
		<div class="container">
			...
			if (isset($_GET['t'])) {
				if ($_GET['t'] != '') {
					header("location: page_change_pass.php");
				}
			}
			?>
						...
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<form action="mail.php" method="post">
									<div class="mt-4">
										<input type="text" name="user_email" placeholder="Email" required class="single-input">
									</div>
									<br>
									<a href="#"><button type="submit" name="btn_email" class="genric-btn primary large circle">Send Email</button></a>
								</form>
							</div>
						</div>
					</div>
