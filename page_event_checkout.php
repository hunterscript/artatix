        ...
        <div class="container">
            <div class="section-top-border">
                <div class="row">
                        ...
                        while ($row = mysqli_fetch_array($queryrow)) {
                            ...
                            <form action="page_event_cart_form_proses.php" method="post">
                                ...
                                <div class="form-group m-0">
                                    ...
                                    <input type="text" name="cst_no_id" class="form-control">
                                </div>
                    ...
                    <aside class="col-lg-4">
                        <div class="card">
                            <div class="body">
                                ...
                                <dl class="dlist-align">
                                    <dt>Subtotal:</dt>
                                    <dd class="text-right"><?= $row['tkt_price'] ?></dd>
                                </dl>
                                ...
                                <dl class="dlist-align">
                                    <dt>Total:</dt>
                                    <?php $total += $row['tkt_price'] * $row['cart_qty']  ?>
                    ...
                    <input type="hidden" name="cst_id"value="<?php echo $cstID ?>">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;<a href="page_event_invoice.php"><button type="submit" name="tambah" class="genric-btn primary circle">Checkout</button></a>
                    </form>
                </div>
